...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">  
			...
			<div class="container">
					<h2 class="mt-3 font-semibold text-xl">{{ $postinganKegiatan->judul_postingan_kegiatan }}</h2>
					<p>Penulis: {{ $postinganKegiatan->penulis }}</p>

					<img src="{{url('/images/'.$postinganKegiatan->gambar_postingan_kegiatan)}}" width="100%" alt="Image" class="py-3"/>
